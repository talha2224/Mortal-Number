...
router.put('/:id',authorized,image_upload.single('image'),catchAsync (async(req,res)=>{
    ...
    let {firstname,lastname,email,password,username,phonenumber,credit,dateOfBirth,gender,country,accountBlocked} = req.body
    let image = req?.file?.filename
    let updateSetter = await GetterServices.update(id,firstname,lastname,email,password,username,phonenumber,credit,dateOfBirth,gender,country,image,accountBlocked)
